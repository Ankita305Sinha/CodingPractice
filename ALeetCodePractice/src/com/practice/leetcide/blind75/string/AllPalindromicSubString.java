package com.practice.leetcide.blind75.string;
...
public class AllPalindromicSubString {
	...
	// consider element selected as a middle element and then proceed leftt-- and right++ anch check if its still apalindrome
